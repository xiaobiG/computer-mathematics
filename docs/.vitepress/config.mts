...
export default defineConfig({
  ...
  themeConfig: {
    ...
    sidebar: {
      '/foundations/': [{ text: '计算机数学预备知识', items: [{ text: '开始学习', link: '/foundations/' }, { text: '符号、函数、求和与 Python', link: '/foundations/functions-summation-python' }] }],
      '/linear-algebra/': [{ text: '程序员的线性代数', items: [{ text: '开始学习', link: '/linear-algebra/' }, { text: 'v0.2 重写清单', link: '/linear-algebra/rewrite-plan' }, { text: '向量与点积', link: '/linear-algebra/vectors-dot-product' }, { text: '线性组合、基与维度', link: '/linear-algebra/linear-combinations-basis' }, { text: '矩阵的四个基本子空间', link: '/linear-algebra/four-fundamental-subspaces' }, { text: '矩阵乘法与线性变换', link: '/linear-algebra/matrix-multiplication' }, { text: '高斯消元：解线性方程组', link: '/linear-algebra/gaussian-elimination' }, { text: 'LU 分解与主元选择', link: '/linear-algebra/lu-factorization-pivoting' }, { text: '正交投影、Gram–Schmidt 与 QR', link: '/linear-algebra/orthogonal-projection-qr' }, { text: '最小二乘：没有精确解怎么办', link: '/linear-algebra/least-squares' }, { text: '特征值与 PCA', link: '/linear-algebra/eigenvalues-pca' }, { text: '幂迭代：主特征方向', link: '/linear-algebra/power-iteration' }, { text: 'SVD：矩阵的通用分解', link: '/linear-algebra/svd' }, { text: '低秩图像压缩', link: '/linear-algebra/low-rank-image-compression' }, { text: '图像误差指标：MSE 与 PSNR', link: '/linear-algebra/image-error-metrics' }, { text: '随机范围发现：近似低秩结构', link: '/linear-algebra/randomized-range-finder' }, { text: '低秩推荐：缺失评分如何建模', link: '/linear-algebra/low-rank-recommendation' }, { text: 'Jacobian、Hessian 与自动微分', link: '/linear-algebra/jacobian-hessian-autodiff' }] }],
      '/discrete-math/': [{ text: '算法背后的离散数学', items: [{ text: '开始学习', link: '/discrete-math/' }, { text: '深度版路线', link: '/discrete-math/rewrite-plan' }, { text: '命题逻辑、量词与归纳法', link: '/discrete-math/logic-induction-proofs' }, { text: '集合、关系、等价类与偏序', link: '/discrete-math/sets-relations-orders' }, { text: '循环不变量与二分查找', link: '/discrete-math/loop-invariants' }, { text: '复杂度：算法规模如何影响时间', link: '/discrete-math/asymptotic-complexity' }, { text: '图、树、二分图与拓扑排序', link: '/discrete-math/graph-foundations-topological-sort' }, { text: 'BFS：图中的最短步数', link: '/discrete-math/breadth-first-search' }, { text: 'DFS：发现时间与显式栈', link: '/discrete-math/depth-first-search' }, { text: '强连通分量：互相可达与凝聚图', link: '/discrete-math/strongly-connected-components' }, { text: '递推关系与分治复杂度', link: '/discrete-math/recurrences' }, { text: 'Dijkstra：带权图最短路', link: '/discrete-math/dijkstra' }, { text: 'Bellman–Ford：负边最短路', link: '/discrete-math/bellman-ford' }, { text: 'Floyd–Warshall：全源最短路', link: '/discrete-math/floyd-warshall' }, { text: '最短路算法选择：同图对照', link: '/discrete-math/shortest-path-algorithm-selection' }, { text: '最大流最小割：残量网络', link: '/discrete-math/max-flow-min-cut' }, { text: '并查集与动态连通性', link: '/discrete-math/union-find' }, { text: '贪心算法：交换论证', link: '/discrete-math/greedy-exchange-arguments' }, { text: '动态规划：状态与 DAG', link: '/discrete-math/dynamic-programming-dag' }, { text: 'P、NP 与多项式归约', link: '/discrete-math/p-np-reductions' }] }],
      '/probability-ml/': [{ text: '机器学习需要的概率论', items: [{ text: '开始学习', link: '/probability-ml/' }, { text: '深度版路线', link: '/probability-ml/rewrite-plan' }, { text: '概率空间与事件', link: '/probability-ml/probability-space-events' }, { text: '条件概率与贝叶斯更新', link: '/probability-ml/bayes' }, { text: '联合、边缘与条件分布', link: '/probability-ml/joint-marginal-conditional' }, { text: '期望、方差与不确定性', link: '/probability-ml/expectation-variance' }, { text: '协方差、相关性与特征', link: '/probability-ml/covariance-correlation' }, { text: '大数定律与中心极限定理', link: '/probability-ml/laws-of-large-numbers-clt' }, { text: '抽样误差与置信区间', link: '/probability-ml/confidence-intervals-sampling' }, { text: '最大似然：从数据估计参数', link: '/probability-ml/maximum-likelihood' }, { text: '交叉熵与 KL 散度', link: '/probability-ml/cross-entropy-kl' }, { text: '生成模型、朴素贝叶斯与逻辑回归', link: '/probability-ml/generative-discriminative-logistic' }, { text: '共轭先验与后验预测', link: '/probability-ml/conjugate-priors-predictive' }, { text: '常见分布如何建模现实', link: '/probability-ml/common-distributions' }, { text: '假设检验与 p 值', link: '/probability-ml/hypothesis-testing' }, { text: '蒙特卡洛与重要性采样', link: '/probability-ml/monte-carlo-importance-sampling' }, { text: 'Metropolis–Hastings：MCMC 采样', link: '/probability-ml/metropolis-hastings' }, { text: '概率校准与可靠性曲线', link: '/probability-ml/calibration-reliability' }, { text: '概率再校准：验证集把分数变回概率', link: '/probability-ml/recalibration' }, { text: '数据漂移监控：何时不应再相信校准概率', link: '/probability-ml/data-drift-monitoring' }, { text: '带标签窗口：性能退化审计', link: '/probability-ml/labeled-window-performance-degradation' }, { text: '联合证据：输入漂移与带标签性能', link: '/probability-ml/joint-input-label-evidence' }] }],
      '/numerical-computing/': [{ text: '数值误差与浮点数', items: [{ text: '开始学习', link: '/numerical-computing/' }, { text: '深度版路线', link: '/numerical-computing/rewrite-plan' }, { text: '浮点数表示', link: '/numerical-computing/floating-point' }, { text: '绝对/相对误差与消去', link: '/numerical-computing/error-propagation' }, { text: '算法稳定性：二次公式', link: '/numerical-computing/algorithmic-stability' }, { text: '直接法与选主元', link: '/numerical-computing/direct-methods-pivoting' }, { text: '牛顿法与收敛', link: '/numerical-computing/newton-method' }, { text: '割线法：不用导数求根', link: '/numerical-computing/secant-method' }, { text: '迭代解线性方程组', link: '/numerical-computing/iterative-linear-systems' }, { text: '预条件共轭梯度法', link: '/numerical-computing/preconditioned-conjugate-gradient' }, { text: 'Kahan 求和：减少累计误差', link: '/numerical-computing/kahan-summation' }, { text: '条件数：问题对误差有多敏感', link: '/numerical-computing/condition-number' }, { text: '浮点比较、容差与属性测试', link: '/numerical-computing/tolerances-property-testing' }, { text: '数值微分与步长选择', link: '/numerical-computing/numerical-differentiation' }, { text: '数值插值：差商与外推', link: '/numerical-computing/interpolation' }, { text: '数值积分：从求和逼近面积', link: '/numerical-computing/numerical-integration' }, { text: '随机模拟的误差与可复现性', link: '/numerical-computing/stochastic-simulation-reproducibility' }] }],
