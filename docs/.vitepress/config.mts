...
export default defineConfig({
  ...
  themeConfig: {
    ...
    sidebar: {
      '/linear-algebra/': [{ text: '程序员的线性代数', items: [{ text: '开始学习', link: '/linear-algebra/' }, { text: 'v0.2 重写清单', link: '/linear-algebra/rewrite-plan' }, { text: '向量与点积', link: '/linear-algebra/vectors-dot-product' }, { text: '线性组合、基与维度', link: '/linear-algebra/linear-combinations-basis' }, { text: '矩阵乘法与线性变换', link: '/linear-algebra/matrix-multiplication' }, { text: '高斯消元：解线性方程组', link: '/linear-algebra/gaussian-elimination' }, { text: '最小二乘：没有精确解怎么办', link: '/linear-algebra/least-squares' }, { text: '特征值与 PCA', link: '/linear-algebra/eigenvalues-pca' }, { text: 'SVD：矩阵的通用分解', link: '/linear-algebra/svd' }] }],
