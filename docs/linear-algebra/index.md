...
| 13 | [低秩推荐](/linear-algebra/low-rank-recommendation) | 缺失评分如何变成可学习的预测？ | 深度正文 · 70 分钟 |
| 14 | [Jacobian、Hessian 与自动微分](/linear-algebra/jacobian-hessian-autodiff) | 梯度如何成为可计算的线性代数？ | 深度正文 · 65 分钟 |
