...
- [数值微分](/numerical-computing/numerical-differentiation)：截断/舍入误差、步长选择与复步长的解析性边界；
...
- [重要性采样诊断](/numerical-computing/importance-sampling-diagnostics)：比较提议分布、权重、标准误与 ESS；
